...
class mclass:
    ...
    def __init__(self, window):
        ...
        self.button3 = Button(window, text="Finish & Plot", command=self.plot,bg="purple",activeforeground="purple")
        self.button3.pack()

        var1 = StringVar()
        var1.set("Entrez X :")
        label1 = Label(window, textvariable=var1, height=2,bg='pink',fg="purple")
        label1.pack()
        ...
        var2 = StringVar()
        var2.set("Entrez Y :")
        label2 = Label(window, textvariable=var2, height=2,bg='pink',fg="purple")
        label2.pack()
        ...
        def onclick(event):
            ...
            ft=[f(i) for i in T]
            plt.plot(T,ft,'g')
            plt.title(r"$P_n(x)="+latex(interpolate(self.supp,x))+"$",fontsize=12, color='purple')
            ID1.set(self.mylist)
    ...
    def plot(self):
        ...
        plt.plot(W[-1], V[-1], 'purple')
        self.a.scatter([u for u, v in iter(self.supp)], [
                       v for u, v in iter(self.supp)], color='purple')
