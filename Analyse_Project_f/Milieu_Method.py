...
class mclass:
    ...
    def __init__(self, window):
        ...
        varTitle = StringVar()
        varTitle.set("Intégration:Méthode de Point Milieu")
        ...
        var1 = StringVar()
        var1.set("La méthode de point Milieu est une méthode de calcul approché d'intégrale") #\n
